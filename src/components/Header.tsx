    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-white/95 backdrop-blur-[10px] shadow-[0_2px_10px_rgba(0,0,0,0.1)] transition-all duration-300">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center">
            <ul className="flex gap-8">
              ...
              <li><Link href="#products" className="text-gray-900 font-medium relative transition-colors duration-300 hover:text-[var(--primary)] after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-0.5 after:bg-[var(--primary)] after:transition-all after:duration-300 hover:after:w-full">Products</Link></li>
              <li><Link href="#features" className="text-gray-900 font-medium relative transition-colors duration-300 hover:text-[var(--primary)] after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-0.5 after:bg-[var(--primary)] after:transition-all after:duration-300 hover:after:w-full">Features</Link></li>
              <li><Link href="#testimonials" className="text-gray-900 font-medium relative transition-colors duration-300 hover:text-[var(--primary)] after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-0.5 after:bg-[var(--primary)] after:transition-all after:duration-300 hover:after:w-full">Testimonials</Link></li>
      ...
      <nav className={`md:hidden fixed top-0 ${isMenuOpen ? 'right-0' : '-right-full'} w-4/5 max-w-sm h-screen bg-white shadow-[-5px_0_15px_rgba(0,0,0,0.1)] transition-all duration-300 flex flex-col justify-center items-center z-[1000]`}>
        <ul className="flex flex-col gap-8 items-center mb-8">
          ...
          <li><Link href="#products" onClick={closeMenu} className="text-gray-900 font-medium text-lg transition-colors duration-300 hover:text-[var(--primary)]">Products</Link></li>
          <li><Link href="#features" onClick={closeMenu} className="text-gray-900 font-medium text-lg transition-colors duration-300 hover:text-[var(--primary)]">Features</Link></li>
          <li><Link href="#testimonials" onClick={closeMenu} className="text-gray-900 font-medium text-lg transition-colors duration-300 hover:text-[var(--primary)]">Testimonials</Link></li>
